...
with open('../Query/load_esmartdata_learningpath.sql', 'r', encoding='utf-8') as file:
    sql = file.read()

cur.executescript(sql)

with open('../Query/load_esmartdata_learningpath_courses.sql', 'r', encoding='utf-8') as file:
    sql = file.read()
